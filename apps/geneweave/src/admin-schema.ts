...
export const ADMIN_TAB_GROUPS: AdminTabGroup[] = [
  ...
  { label: 'Governance', icon: '\uD83D\uDEE1\uFE0F', tabs: [
    ...
    { key: 'memory-settings', label: 'Memory Settings' },
    { key: 'memory-governance', label: 'Memory Policy' },
    { key: 'memory-extraction-rules', label: 'Memory Rules' },
    { key: 'semantic-memory', label: 'Semantic Memory' },
    { key: 'entity-memory', label: 'Entity Memory' },
    { key: 'episodic-memory', label: 'Episodic Memory' },
    { key: 'procedural-memory', label: 'Procedural Memory' },
