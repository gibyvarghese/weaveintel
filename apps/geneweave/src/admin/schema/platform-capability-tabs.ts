...
export const PLATFORM_CAPABILITY_ADMIN_TABS: Record<string, AdminTabDef> = {
  ...
  'weavenotes-settings': {
    ...
    fields: [
      ...
      { key: 'background_memory_enabled', label: 'Background memory ("second brain") — quietly remember durable facts/preferences/decisions from notes over time', type: 'checkbox', save: 'bool', default: true },
      { key: 'memory_importance_threshold', label: 'Only remember memories at/above this importance (0–1; lower remembers more)', type: 'number', save: 'float', default: 0.3 },
      { key: 'memory_max_per_note', label: 'Most durable memories to keep from one note', type: 'number', save: 'int', default: 8 },
      { key: 'memory_recall_count', label: 'How many memories to surface on a proactive recall', type: 'number', save: 'int', default: 5 },
      { key: 'memory_decay_half_life_days', label: 'Recency half-life (days) — older memories fade in recall unless re-seen', type: 'number', save: 'int', default: 30 },
