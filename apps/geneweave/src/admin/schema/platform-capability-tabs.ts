...
export const PLATFORM_CAPABILITY_ADMIN_TABS: Record<string, AdminTabDef> = {
  ...
  'sg-channels': {
    ...
    fields: [
      ...
      { key: 'platform', label: 'Platform', options: ['linkedin', 'instagram', 'facebook', 'tiktok', 'youtube', 'medium', 'blogger', 'x', 'pinterest', 'substack', 'threads', 'reddit', 'mastodon'], default: 'linkedin' },
  ...
  'sg-platform-configs': {
    singular: 'SG Platform Config', apiPath: 'admin/sg-platform-configs', listKey: 'sg-platform-configs',
    cols: ['platform', 'display_name', 'max_char_limit', 'enabled'],
    fields: [
      { key: 'platform', label: 'Platform', options: ['linkedin', 'instagram', 'facebook', 'tiktok', 'youtube', 'medium', 'blogger', 'x', 'pinterest', 'substack', 'threads', 'reddit', 'mastodon'], default: 'linkedin' },
      { key: 'display_name', label: 'Display Name' },
      { key: 'icon_emoji', label: 'Icon Emoji' },
      { key: 'max_char_limit', label: 'Max Character Limit', type: 'number', save: 'int' },
      { key: 'max_video_length_seconds', label: 'Max Video Length (s)', type: 'number', save: 'int' },
      { key: 'supported_formats', label: 'Supported Formats (JSON)', textarea: true, save: 'jsonStr' },
      { key: 'hashtag_limit', label: 'Hashtag Limit', type: 'number', save: 'int' },
      { key: 'link_in_bio_only', label: 'Link in Bio Only', type: 'checkbox', save: 'intBool' },
      { key: 'api_endpoint', label: 'API Endpoint' },
      { key: 'analytics_fields', label: 'Analytics Fields (JSON)', textarea: true, save: 'jsonStr' },
      { key: 'posting_tips', label: 'Posting Tips', textarea: true },
      { key: 'enabled', label: 'Enabled', type: 'checkbox', save: 'bool', default: true },
    ],
  },
  'sg-campaigns': {
