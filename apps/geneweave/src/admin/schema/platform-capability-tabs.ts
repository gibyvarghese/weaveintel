...
export const PLATFORM_CAPABILITY_ADMIN_TABS: Record<string, AdminTabDef> = {
  ...
  'sgap-phase3-configs': {
    singular: 'SGAP Phase 3 Config', apiPath: 'admin/sgap-phase3-configs', listKey: 'sgap-phase3-configs',
    cols: ['brand_id', 'workflow_template_id', 'publish_mode', 'schedule_strategy', 'enabled'],
    fields: [
      { key: 'application_scope', label: 'Scope', default: 'sgap' },
      { key: 'brand_id', label: 'Brand ID' },
      { key: 'workflow_template_id', label: 'Workflow Template ID' },
      { key: 'social_manager_agent_id', label: 'Social Manager Agent ID' },
      { key: 'analytics_agent_id', label: 'Analytics Agent ID' },
      { key: 'primary_platforms_json', label: 'Primary Platforms (JSON)', textarea: true, save: 'jsonStr', default: '["linkedin","instagram","medium"]' },
      { key: 'publish_mode', label: 'Publish Mode', options: ['draft', 'publish'], default: 'draft' },
      { key: 'schedule_strategy', label: 'Schedule Strategy', options: ['best_window', 'fixed', 'rolling'], default: 'best_window' },
      { key: 'min_engagement_target', label: 'Min Engagement Target', type: 'number', save: 'float', default: 0.03 },
      { key: 'require_analytics_snapshot', label: 'Require Analytics Snapshot', type: 'checkbox', save: 'bool', default: true },
      { key: 'enabled', label: 'Enabled', type: 'checkbox', save: 'bool', default: true },
    ],
  },
  'sgap-distribution-plans': {
    singular: 'SGAP Distribution Plan', apiPath: 'admin/sgap-distribution-plans', listKey: 'sgap-distribution-plans',
    cols: ['workflow_run_id', 'content_item_id', 'platform', 'publish_mode', 'status', 'scheduled_for'],
    fields: [
      { key: 'application_scope', label: 'Scope', default: 'sgap' },
      { key: 'workflow_run_id', label: 'Workflow Run ID' },
      { key: 'content_item_id', label: 'Content Item ID' },
      ...
      { key: 'tool_name', label: 'Tool Name' },
      { key: 'distribution_text', label: 'Distribution Text', textarea: true, rows: 8 },
      { key: 'hashtags_json', label: 'Hashtags (JSON)', textarea: true, save: 'jsonStr' },
      { key: 'optimization_notes_json', label: 'Optimization Notes (JSON)', textarea: true, save: 'jsonStr' },
      { key: 'tool_result_json', label: 'Tool Result (JSON)', textarea: true, save: 'jsonStr' },
      { key: 'status', label: 'Status', options: ['planned', 'scheduled', 'published', 'failed'], default: 'planned' },
    ],
  },
