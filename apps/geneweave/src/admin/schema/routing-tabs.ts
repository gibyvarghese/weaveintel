...
export const ROUTING_ADMIN_TABS: Record<string, AdminTabDef> = {
  ...
  'message-feedback': {
    singular: 'Answer Feedback', apiPath: 'admin/message-feedback', listKey: 'feedback',
    cols: ['signal', 'categories', 'message_id', 'chat_id', 'user_id', 'created_at'],
    fields: [
      { key: 'id', label: 'ID', readonly: true },
      { key: 'message_id', label: 'Message ID', readonly: true },
      ...
      { key: 'signal', label: 'Signal (thumbs up / down / regenerate / copy)', readonly: true },
      { key: 'categories', label: 'Down-vote reasons (why it wasn’t good)', readonly: true },
