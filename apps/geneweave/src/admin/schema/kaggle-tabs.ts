...
export const KAGGLE_ADMIN_TABS: Record<string, AdminTabDef> = {
  ...
  'kaggle-competition-runs': {
    singular: 'Live Competition Run',
    ...
    fields: [
      ...
      { key: 'objective', label: 'Objective', textarea: true, readonly: true },
      { key: 'status', label: 'Status', readonly: true },
      { key: 'mesh_id', label: 'Mesh ID (live-agents)', readonly: true },
      { key: 'submitted_by', label: 'Submitted By', readonly: true },
      { key: 'step_count', label: 'Step Count', readonly: true },
      { key: 'event_count', label: 'Event Count', readonly: true },
