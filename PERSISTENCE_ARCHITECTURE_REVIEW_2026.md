...
- **Remaining:** only `@weaveintel/live-agents`' StateStore (a generic `la_entities` JSON table + in-memory hydration Proxy — thin SQL, ~300 lines of shared dispatch boilerplate to dedupe) is left; it follows the identical template.
